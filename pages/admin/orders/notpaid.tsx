...
const NotPaidOrdersPage = () => {
  const { data, error } = useSWR<IOrder[]>('/api/admin/orders?isPaid=false&orderState=pending');
  ...
  const onStatusUpdated = async (orderId: string, status: string) => {
